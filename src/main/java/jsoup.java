...
public class jsoup {
    public static void main(String[] args) throws IOException {
        //Very basic test - returns the price of some headphones - 119.90
        ...
        Elements question = document.select(".priceBlockSavingsString");
        System.out.println("You save " + question.html());
